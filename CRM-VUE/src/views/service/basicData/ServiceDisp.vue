<template>
  <div>
    ...
    >
      <ServiceDispAdd @onAdd="onAdd" @reInit="reInit" :multiple="this.multipleSelection"></ServiceDispAdd>
    </el-dialog>
    <!-- 修改 -->
    <!-- <el-dialog
      title="服务管理-服务创建"
...
<script>
import ServiceDispAdd from "../management/ServiceDispAdd.vue";
  ...
  data() {
    return {
      ...
      tableColumns: [
        ...
        { key: "overview", name: "概要信息", width: 675 },
