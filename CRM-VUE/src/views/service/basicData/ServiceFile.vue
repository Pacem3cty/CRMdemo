    ...
    <div class="demo-input-size">
      ...
      <div class="i-div-r">
        <!-- <el-tooltip
          ...
          placement="left"
        > -->
        <!-- <el-button type="primary" style="margin-top: 9px" @click="ondetails"
          >反馈服务</el-button
        > -->
        <!-- </el-tooltip> -->
      </div>
...
<script>
// import ServiceFeedbackAdd from "../management/ServiceFeedbackAdd.vue";
    ...
    return {
      ...
      tableColumns: [
       { key: "id", name: "编号", width: 50 },
        ...
        { key: "overview", name: "概要信息", width: 180 },
        { key: "assignPerson", name: "分配人", width: 80 },
        { key: "assignDate", name: "分配时间", width: 100 },
        { key: "processPerson", name: "处理人", width: 80 },
        { key: "processDate", name: "处理时间", width: 100 },
        { key: "processResult", name: "处理结果", width: 180 },
        { key: "csr", name: "客户满意度", width: 100 },
  ...
  methods: {
    ...
    queryAll() {
      ...
      const params = {
        ...
        // assignPerson:localStorage.getItem("trueName"),
        state: 3,
      };
      this.$store
        ...
        .then(() => {
          if (this.$store.state.Service.serviceInfo.code === 200) {
            ...
            this.currentPage =
              this.$store.state.Service.serviceInfo.data.current;
