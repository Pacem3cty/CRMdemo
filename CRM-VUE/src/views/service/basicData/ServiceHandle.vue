<template>
  <div>
    ...
    >
      <ServiceHandleAdd @onAdd="onAdd" @reInit="reInit" :multiple="this.multipleSelection"></ServiceHandleAdd>
    </el-dialog>
    <!-- 修改 -->
    <!-- <el-dialog
      title="服务管理-服务创建"
...
<script>
import ServiceHandleAdd from "../management/ServiceHandleAdd.vue";
  ...
  data() {
    return {
      ...
      tableColumns: [
        ...
        { key: "overview", name: "概要信息", width: 495 },
