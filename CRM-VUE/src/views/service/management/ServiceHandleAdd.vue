      ...
      <el-form ref="addForm" :model="addForm" :rules="rules" size="medium" label-width="100px">
        <el-col :span="12">
          <el-form-item label="服务序号" prop="id">
            <el-input v-model="addForm.id" placeholder="请输入服务序号" readonly clearable :style="{width: '100%'}">
            </el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="服务类型" prop="serviceType">
            <el-select v-model="addForm.serviceType" placeholder="请选择服务类型" :disabled='true'
              :style="{width: '100%'}">
              <el-option v-for="(item, index) in serviceTypeOptions" :key="index" :label="item.label"
        ...
        <el-col :span="24">
          <el-form-item label="客户" prop="customer">
            <el-input v-model="addForm.customer" placeholder="请输入客户" readonly clearable
              :style="{width: '100%'}"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="24">
          <el-form-item label="服务内容" prop="serviceRequest">
            <el-input v-model="addForm.serviceRequest" type="textarea" placeholder="请输入服务内容" readonly
              :autosize="{minRows: 4, maxRows: 4}" :style="{width: '100%'}"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="24">
          <el-form-item label="服务概要" prop="overview">
            <el-input v-model="addForm.overview" type="textarea" placeholder="请输入服务概要" readonly
              :autosize="{minRows: 4, maxRows: 4}" :style="{width: '100%'}"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="分配人" prop="assignPerson">
            <el-input v-model="addForm.assignPerson" placeholder="请输入分配人" :disabled='true'
              :style="{width: '100%'}"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="分配时间" prop="assignDate">
            <el-input v-model="addForm.assignDate" placeholder="请输入分配时间" :disabled='true'
              :style="{width: '100%'}"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="24">
          <el-form-item label="服务处理" prop="serviceProcess">
            <el-input v-model="addForm.serviceProcess" type="textarea" placeholder="请输入服务处理"
              :autosize="{minRows: 4, maxRows: 4}" :style="{width: '100%'}"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="24">
      ...
      this.$refs["addForm"].validate((valid) => {
        if (valid) {
          const params = {
            ...
            serviceProcess: this.addForm.serviceProcess,
            processPerson: localStorage.getItem("trueName"),
            state:2
          };
          this.$store
